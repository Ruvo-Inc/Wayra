 ...
 */
router.get('/', authenticateUser, rateLimitMiddleware, async (req, res) => {
  try {
 ...
 * Create a new trip
 */
router.post('/', authenticateUser, rateLimitMiddleware, async (req, res) => {
  try {
    const {
      title,
      description,
 ...
 */
router.get('/:id', authenticateUser, rateLimitMiddleware, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 * Update a trip
 */
router.put('/:id', authenticateUser, rateLimitMiddleware, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 * Delete a trip
 */
router.delete('/:id', authenticateUser, rateLimitMiddleware, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.post('/:id/collaborators', authenticateUser, rateLimitMiddleware, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.get('/:id/activity', authenticateUser, rateLimitMiddleware, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.get('/:id/presence', authenticateUser, rateLimitMiddleware, async (req, res) => {
  try {
    const { id } = req.params;
